...
const Paginator: React.FC<{setPage: CallableFunction, page: number}> = (props) => {
    ...
    return <div className="Paginator">
        <ul className="pagination">
            ...
            <li className="page-item"><div className="page-link fw-bold">{props.page}</div></li>
            <li className="page-item"><button className="page-link" onClick={() => props.setPage(props.page + 1)}>{">"}</button></li>
        </ul>
    </div>
}
