...
const Paginator: React.FC<{setPage: CallableFunction, page: number}> = (props) => {
    ...
    return <div className="Paginator">
        <ul className="pagination">
            {props.page > 1 ? <li className="page-item"><button className="page-link link-success" onClick={() => props.setPage(props.page - 1)}>{"<"}</button></li> : null}
            {props.page > 1 ? <li className="page-item"><button className="page-link link-success" onClick={() => props.setPage(1)}>1</button></li> : null}
